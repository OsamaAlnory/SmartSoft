<%@ Page Title="Firts_Login_Stud" Language="C#" MasterPageFile="~/Pages/LoginService.Master" AutoEventWireup="true" CodeBehind="StudentFirstLogin.aspx.cs" Inherits="SmartSoft.Pages.StudentFirstLogin" %>
                ...
                <div class="wrap-login100 p-t-30 p-b-50">
                    ...
                    <form class="login100-form validate-form p-b-33 p-t-5 bg ">
						...
						<span class="focus-input100" data-placeholder="&#xe800;"></span>
                           ...
                           <div class="wrap-input100 validate-input" data-validate = "Phonenr">
						<input class="input100" id="Phonenr" type="number" name="Phonenr" runat="server" placeholder="Mobiltelefon">
						<span class="focus-input100" data-placeholder="&#xe800;"></span>
					</div>
                     
                         <div class="wrap-input100 validate-input" data-validate = "Profile-Logo">
                              <center><label for="file2" id="lbl1" class=" egen1 text-center">Profile-Bild:</label></center>
 					</div>
                         <div class="wrap-input100 validate-input" data-validate = "Profile-Logo">
